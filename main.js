...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		if((keyPressed >=97 && keyPressed<=122)|| (keyPressed >=65 && keyPressed<=90)){
			...
			numberkey();
			document.getElementById("d1").innerHTML="Você precionou uma tecla numérica";
			...
			arrowkey();
			document.getElementById("d1").innerHTML="Você precionou uma tecla direcional";
			...
			specialkey();
			document.getElementById("d1").innerHTML="Você precionou uma tecla especial (ctrl\esc\alt)";
